...
let span = document.querySelector('.show-video span');
let video1 = document.querySelector('.show-video div video');
//人物弹出
...
function show(){
     ...
     video.addEventListener('click', () => {
          per(showVideo,span,video1)
           setTimeout(function () {
                alert('播放视频时，请将鼠标移出视频区域，以免影响观看体验！')
           }, 1000)
      })
